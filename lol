...
TextLabel.Text = "mini c00lkidd kurd "
...
TextLabel_2.Text = "by unknown people"
...
jumpscare2.Text = "jumpscare fixed!"
...
jumpscare1.Name = "unknown people"
...
local function HDTLA_script() -- skybox.Script 
	...
	function click()
		...
		s.SkyboxBk = "http://www.roblox.com/asset/?id=90076808982788"
		s.SkyboxDn = "http://www.roblox.com/asset/?id=90076808982788"
		s.SkyboxFt = "http://www.roblox.com/asset/?id=90076808982788"
		s.SkyboxLf = "http://www.roblox.com/asset/?id=90076808982788"
		s.SkyboxRt = "http://www.roblox.com/asset/?id=90076808982788"
		s.SkyboxUp = "http://www.roblox.com/asset/?id=90076808982788"
...
local function HDSMI_script() -- music2.Script 
	...
	function onClick()
		...
		tubers93.SoundId		= "rbxassetid://138243251730321"
...
local function HNSKCE_script() -- particlesspam.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
			...
			emit.Texture = "http://www.roblox.com/asset/?id=90076808982788"
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newimage.Image = "http://www.roblox.com/asset/?id=86111499975812"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://91299590639144"
					s.Volume = 99999999999999
					s.Looped = true
					s:Play()
	...
	function click()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=84949535079311" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					Two.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					Three.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					Four.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					Five.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					Six.Texture = "http://www.roblox.com/asset/?id=84949535079311"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
